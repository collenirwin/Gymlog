#pragma checksum "C:\Users\lance\Documents\Programs\Gymlog\Gymlog\Gymlog\Views\Home\Timer.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3b21ce00a1e232f288c40977fd8ca09f2158157e"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3b21ce00a1e232f288c40977fd8ca09f2158157e", @"/Views/Home/Timer.cshtml")]
...
<div id=""app"">
    ...
    <a");
            EndContext();
            BeginWriteAttribute("href", " href=", 970, "", 992, 1);
#line 49 "C:\Users\lance\Documents\Programs\Gymlog\Gymlog\Gymlog\Views\Home\Timer.cshtml"
WriteAttributeValue("", 976, ViewBag.AuthUri, 976, 16, false);

#line default
#line hidden
            EndWriteAttribute();
            BeginContext(992, 10932, true);
...
<script>
  ...
  ");
            WriteLiteral(@"              localStorage.setItem('timer', this.hr + "":"" + this.min + "":"" + this.sec);
        ...
        computed: {
            ...
            minutes() {
                if (this.start && this.timer !== ""00:00:00"" && this.date - this.now > 0) {
                    if ");
            WriteLiteral(@"((Math.trunc((this.date - this.now) / 60) % 60) < 10 || (Math.trunc((this.date - this.now) / 60) % 60) === 0) {
      ...
      ");
        ...
        ready: function () {
            ...
            if (myData == null) {
                ...
                this.hr = Number(s[0]);
           ");
            WriteLiteral(@"     this.timer = myData;
                this.date = (new Date().getTime() + (this.hr * 60 * 60 * 1000) + (this.min * 60 * 1000) + (this.sec * 1000)) / 1000;
    ...
    <button type=""button"" v-on:click=""begin"">Start</button>\
    <b");
            WriteLiteral(@"utton type=""button"" v-on:click=""reset"">Reset</button>\
    <button type=""button"" v-on:click=""pause"">Pause</button>\
    <button type=""button"" v-on:click=""resume"">Resume</button>\
</div>',
        data() {
        ...
        comput");
            ...
            milliseconds() {
                if (this.start) {
                    return (((this.now - this.date) % 100) % 1).toFix");
            WriteLiteral(@"ed(2).replace(/^0+/, '');
                }
                return ""0"";
            },
            hours() {
