#pragma checksum "C:\Users\lance\Documents\Programs\gymClone12_9\Gymlog\Gymlog\Views\Home\Timer.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9d4b98c772e0b1cb4793f9cc92af5df3900d5e00"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9d4b98c772e0b1cb4793f9cc92af5df3900d5e00", @"/Views/Home/Timer.cshtml")]
...
<div class=""row"">
    <div class=""col-md-12"">
        <div id=""app"">
            ...
            <Stopwatch v-if=""!show_compone");
            WriteLiteral(@"nt""></Stopwatch>
  ...
  ");
        ...
        methods: {
            ...
            WriteLiteral(@").getTime() / 1000);
                    }, 1000);
                } else if (this.timer !== ""00:00:00"" && this.pause_resume === 1) {
                    this.pause();
                }
            ...
            seconds() {
                if (this.start && this.timer !== ""00:00:00"" && this.date - this.now > 0) {
                    if ((Math.trunc((this.date - this.now) % 60)) === 0 && this.minutes === 0 && this.hours === 0) {
                        ...
                        localStorage.removeItem('bool');
   ");
            WriteLiteral(@"                     localStorage.removeItem('timestamp');
                        localStorage.removeItem('paused');
                    }
            ...
            minutes() {
                if (this.start && this.timer !== ""00:00:00"" && this.date - this.now > 0) {
                    if ((Math.trunc((this.date - this.now) / 60) % 60) < 10 || (Math.trunc((this.date - this.now) / 60) % 60) === 0) {
                        this.min = ""0"" + (Math.trunc((this.date - this.now) / 60) % ");
            WriteLiteral(@"60).toString();
        ...
        ready: function () {
            ...
            if (myData == null || myData == ""00:00:00"") {
                ...
                this.hr = Number(s[0]);
                this.timer = myData;
                this.date = (new Date().getTime() + (this.hr * 60 * 60 * 1000) + (this.min * 60");
            WriteLiteral(@" * 1000) + (this.sec * 1000)) / 1000;
                if (paused == 2) {
                    this.pause_resume = 1;
                    this.button_text = ""Resume"";
                } else if (paused == 1) {
    ...
    <div>\
        ...
        methods: {
            ...
            begin: function () {
                console.log");
            WriteLiteral(@"(this.pause_resume);
                if (this.timer == ""00:00:00"" && this.pause_resume == 0) {
                    this.start = 1;
                    let s = this.timer.split("":"");
                    this.sec = Number(s[2]);
                    ...
                    this.pause_resume = 2;
 ");
            WriteLiteral(@"                   this.button_text = ""Resume"";

                } else if (this.pause_resume == 2) {
                    console.log(""Paused_time: "" + this.paused_time);
                        let curr = new Date().getTime() / 1000;
 ...
 ");
            WriteLiteral(@"                   localStorage.setItem('stopwatch_paused', this.pause_resume);
        ...
        computed: {
           ");
            WriteLiteral(@" seconds() {
                if (this.start) {
                    if (Math.trunc((this.now - this.date) % 60) < 10) {
