#pragma checksum "C:\Users\epere\OneDrive\Gymlog\Gymlog\Views\Home\Timer.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "125d0bdd5eac0139bd9a96f2faa237810309cab4"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"125d0bdd5eac0139bd9a96f2faa237810309cab4", @"/Views/Home/Timer.cshtml")]
       ...
       ");
           ...
           /* test: function () {
                window.onbeforeunload = function () {
                    con");
            WriteLiteral(@"sole.log(this.hours + "":"" + this.minutes + "":"" + this.seconds);
                    localStorage.setItem('timestamp', new Date().getTime() / 1000);
                    localStorage.setItem('timer', this.hours + "":"" + this.minutes + "":"" + this.test);
            ...
            seconds() {
                if (this.start && this.timer !== ""00:00:00"" && this.date - this.now > 0) {
                    ...
                    if ((Math.trunc((this.date - this.now) % 60)) < 10 || (Math.trunc((this.date - this.now) % 60) === 0)) {
                        this.sec = ""0"" + (Math.trunc((this.");
            WriteLiteral(@"date - this.now) % 60)).toString();
        ...
        ready: function () {
           ...
           /* window.onbeforeunload = function () {
            ...
            if (myData == null) {
                ...
                this.sec = Number(s[2]);
     ");
            WriteLiteral(@"           this.min = Number(s[1]);
                this.hr = Number(s[0]);
                this.timer = myData;
                // this.timer = this.timer_;
                this.date = (new Date().getTime() + (this.hr * 60 * 60 * 1000) + (this.min * 60 * 1000) + (this.sec * 1000)) / 1000;
        ...
        methods: {
            begin: function () {
                if (this.timer === ""00:00:00"") {
                    ...
                    this.min = Number(s[1]);
            ");
            WriteLiteral(@"        this.hr = Number(s[0]);
            ...
            resume: function () {
                ...
                this.interval = window.setInterval(() => {
                ");
            WriteLiteral(@"    this.now = (Date.now() / 1000);
                }, 1);
                this.start = 1;
            }
        },
